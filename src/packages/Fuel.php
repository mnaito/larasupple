...
class Fuel
{
	...
	public static function init($config)
	{
		...
		{
			throw new \Mits430\Larasupple\Packages\FuelException("You can't initialize Fuel more than once.");
		}
	...
	public static function always_load($array = null)
	{
		...
		if (isset($array['classes']))
		{
			foreach ($array['classes'] as $class)
			{
				...
				{
					throw new \Mits430\Larasupple\Packages\FuelException('Class '.$class.' defined in your "always_load" config could not be loaded.');
				}
			}
		}
