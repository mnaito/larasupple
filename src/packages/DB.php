...
class DB
{
	...
	{
		return new \Mits430\Larasupple\Vendor\Database\Database_Query($sql, $type);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->last_query;
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->error_info();
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance()->select(func_get_args());
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance()->select($columns);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance()->insert($table, $columns);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance()->update($table);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance()->delete($table);
	}
	...
	{
		return new \Mits430\Larasupple\Vendor\Database\Database_Expression($string);
	}
	...
	{
		return new \Mits430\Larasupple\Vendor\Database\Database_Expression(static::quote_identifier($string, $db));
	}
	...
	public static function quote($string, $db = null)
	{
		...
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->quote($string);
	}
	...
	public static function quote_identifier($string, $db = null)
	{
		...
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->quote_identifier($string);
	}
	...
	public static function quote_table($string, $db = null)
	{
		...
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->quote_table($string);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->escape($string);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->table_prefix($table);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->list_columns($table, $like);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->list_tables($like);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->datatype($type);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->count_records($table);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->count_last_query();
	}
	...
	{
		\Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->set_charset($charset);
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->in_transaction();
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->start_transaction();
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->commit_transaction();
	}
	...
	{
		return \Mits430\Larasupple\Packages\Database\Database_Connection::instance($db)->rollback_transaction($rollback_all);
	}
