...
class Database_Dblib_Connection extends \Mits430\Larasupple\Vendor\Database\Database_PDO_Connection
{
	/**
	...
	protected function __construct($name, array $config)
	{
		...
		{
			throw new \Mits430\Larasupple\Vendor\Database\Database_Exception('The "Dblib" database driver does not work well on Windows. Use the "Sqlsrv" driver instead.');
		}
